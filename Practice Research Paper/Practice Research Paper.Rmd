...
Our research and development effort were motivated by the general lack of effective and easy to use web-enabled data visualization tool to conduct data analysis on PM operation data. The project aims to enable operation managers the ability to monitor,drill down and identify attributes to the performance indicator.



# II. Review and critic on past work 

Currently, PM operation's performances are tracked using Operation Indicators such as PM productivity and waiting time aggregated by duration, from daily shifts to monthly reports and segregate by individual terminals, equipments, containers and operation types. 

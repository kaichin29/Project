...
![](C:/ISSS608/Project/_posts/2021-02-25-proposal/Examples/Slide7.PNG)

**CDA - Violin / Box Plots**: To visualise the confidence intervals
![](C:/ISSS608/Project/_posts/2021-02-25-proposal/Examples/Slide6.PNG)

**About**: To provide definitions and FAQs 

## Data Source
The data source used is provided by PSA Singapore’s PM OPS dataset that contains anonymised PM operation event records in a generic 12 hr shift. There are approximately 65,000 records with 69 variables. The dataset is reduced to the following 17 variables for the analysis:
...
|     6     |     [MOVE_OP_C]                    |     Move   Operation Code filtered to "O" Ship Ops for this study                                                                                                                                                                                    |
|     7     |     [LENGTH_Q]                     |     Container   Length e.g 20 40 45 48 ft                                                                                                                                                                                                            |
